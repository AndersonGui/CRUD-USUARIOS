'use strict';
var crudusuarios = angular.module("crudusuarios", ["ngRoute", "ngMask"]);
            ...
            fields: [
                ...
                },                                                              
                {
                    ...
                    itemTemplate: function (value, item) {
                        ...
                        var $botaoEditar = $("<i style='color:#00b9ff; margin-right:2%'  class='far fa-1x fa-edit'></i>")
                            .click(function (e) {                                                                                                                    
                        ...
                        var $botaoDeletar = $("<i style='color:red' class='fas fa-1x fa-trash-alt'></i>")
                            .click(function (e) {
                                bootbox.prompt({
